...
PILOTE_FR = dict(
 ...
 meta="Conseil aux entreprises<br />et aux ONG<br />atmart.ltd",
 ...
 amt="à partir de 5 000 $", amt_s="devis ferme après le cadrage",
 price_txt="<b>4 à 6 semaines.</b> Le prix dépend de la complexité de la tâche et du nombre de personnes concernées — il est arrêté par écrit avant de commencer.<br /><b>Deux conditions de réussite :</b> un référent disponible chez vous (2 à 3 heures par semaine) et l'accès aux données nécessaires. Nous menons au maximum 2 pilotes en parallèle.",
 why_t="Pourquoi Atmart",
 why=[("La preuve, pas la démonstration", "Tests, piste d'audit et coût connu : trois choses qu'une démonstration ne donne jamais."),
      ("Le contrôle humain d'abord", "Nous concevons qui valide quoi avant d'écrire la moindre automatisation."),
      ("Vos équipes, leur langue", "Formation et documents en kreyòl, français, anglais ou espagnol.")],
...
PILOTE_EN = dict(
 ...
 meta="Advisory for companies<br />and NGOs<br />atmart.ltd",
 ...
 amt="from $5,000", amt_s="firm quote after scoping",
 price_txt="<b>4 to 6 weeks.</b> The price depends on the complexity of the task and the number of people involved — it is agreed in writing before we start.<br /><b>Two conditions for success:</b> an available point of contact on your side (2 to 3 hours a week) and access to the necessary data. We run at most 2 pilots in parallel.",
 why_t="Why Atmart",
 why=[("Proof, not a demo", "Tests, audit trail and known cost: three things a demo never gives you."),
      ("Human control first", "We design who validates what before writing a single automation."),
      ("Your teams, their language", "Training and documents in English, Haitian Creole, French or Spanish.")],
...
ACC_FR = dict(
 ...
 amt="à partir de 1 000 $/mois", amt_s="mensuel, résiliable à tout moment",
 ...
 why_t="Pourquoi Atmart",
 why=[("La qualité reste prouvable", "Les tests rejoués chaque mois : vous savez si l'outil dérive, vous ne le devinez pas."),
      ("Le logiciel avec le service", "Les licences Career360 Ekip sont comprises — l'équipe pratique entre deux sessions."),
      ("Vous restez libre", "Résiliation à 30 jours, livrables à vous, aucun verrouillage technique.")],
...
ACC_EN = dict(
 ...
 amt="from $1,000/month", amt_s="monthly, cancel any time",
 ...
 why=[("Quality stays provable", "Tests replayed every month: you know whether the tool is drifting, you don't guess."),
      ...
      ("You stay free", "30-day cancellation, deliverables are yours, no technical lock-in.")],
